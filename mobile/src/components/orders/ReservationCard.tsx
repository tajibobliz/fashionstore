...
export function ReservationCard({ reservation }: Props) {
  ...
  const totalItems = reservation.detalles.reduce(
  ...
  return (
    <Pressable
      onPress={() =>
        router.push(`/reservations/${reservation.idReserva}` as any)
      }
    ...
    >
      ...
      <View className="mt-1 flex-row items-center">
        ...
        <Text className="ml-1 text-xs text-gray-500">
          {reservation.sucursal.nombre} · {reservation.sucursal.ciudad.nombre}
        </Text>
      </View>
