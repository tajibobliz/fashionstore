...
export default function DashboardLayout({ role }: { role: DashboardRole }) {
 ...
 <div className={styles.sectionLabel}>{role === 'ADMIN' ? 'Sistema' : role === 'ENCARGADO' ? 'Mi negocio' : 'Mi turno'}</div>
